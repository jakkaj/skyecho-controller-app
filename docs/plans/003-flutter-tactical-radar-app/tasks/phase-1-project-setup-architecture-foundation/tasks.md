...
| [ ] | T008 | Create package import smoke test | Test | T004, T005 | `/Users/jordanknight/github/skyecho-controller-app/apps/tactical_radar/test/unit/package_import_test.dart` | Test imports both packages; verifies constructors callable; test passes | – | Supports plan task 1.5. Needs T004 (dependencies resolved) and T005 (test/unit/ directory exists). Can run in parallel with T001, T006, T007, T009, T010, T011 |
